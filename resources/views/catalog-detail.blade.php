...
@section('content')
    <p class="mx-20 mt-3 text-zinc-600">Trang chủ / Nam</p>
    <div class="flex mx-20 mt-8">
        <div>
    ...
    <div class="flex px-20 mt-6 gap-4">
        <div class="border-r-2 border-solid border-zinc-300 w-3/5">
        ...
        <div class="grow grid grid-cols-4 gap-3">
            @for ($i = 0; $i < 8; $i++)
                <div>
