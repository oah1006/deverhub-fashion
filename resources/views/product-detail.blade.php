...
@section('content')
    <p class="mx-20 mt-3 text-zinc-600">Trang chủ / Nam / Áo/ Áo thun/ AIRism Cotton Áo Thun Cổ Giả Dáng Rộng</p>
    <div class="flex mx-20 gap-8 my-8">
    ...
    <p class="text-3xl font-medium mx-20">Related Products</p>
    
    <div class="flex mx-20 gap-4 mb-8">
        @for ($i = 0; $i < 4; $i++)
                <div>
