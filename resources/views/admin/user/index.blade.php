                ...
                <tbody>
                    @foreach($users as $user)
                        <tr class="text-gray-600">
                            ...
                            <td class="lg:pl-6 py-3 text-zinc-500 hover:underline flex gap-3 items-center">
                                ...
                                <form action="{{ route('admin.users.destroy', $user) }}" method="post" class="flex items-center">
