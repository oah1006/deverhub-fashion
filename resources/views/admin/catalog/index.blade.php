                ...
                <tbody>
                    @foreach($catalogs as $catalog)
                        <tr class="text-gray-600">
                            ...
                            <td class="lg:px-6 py-3">
                                <a href="{{ route('admin.catalogs.show', $catalog) }}" class="text-cyan-500">{{ $catalog->title }}</a>    
                            </td>
                            <td class="lg:px-6 py-3">
                                {{ optional($catalog->parent)->title }}
                            </td>
                            <td class="lg:pl-6 pr-12 py-3 text-zinc-500 hover:underline flex gap-3 items-center">
                                ...
                                <form action="{{ route('admin.catalogs.destroy', $catalog) }}" method="post"  class="flex items-center">
