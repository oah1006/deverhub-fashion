        ...
        <table class="w-full text-left bg-white rounded-lg">
            <thead class="uppercase bg-slate-100 rounded-lg">
                <tr class="text-xs text-zinc-600 font-bold">
                    <td class="lg:px-6 py-3">Name product</td>
                    <td class="lg:px-6 py-3">Quantity</td>
                    <td class="lg:px-6 py-3">Unit Price</td>
            ...
            <tbody>
                @foreach($orderItems as $item)
                    <tr>
                        ...
                        <td class="lg:px-6 py-3 "> 
                            <p class="inline-block px-1 py-0.5 bg-red-200 text-red-700 underline rounded-lg text-sm"></p>
                        </td>
